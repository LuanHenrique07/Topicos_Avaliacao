public class Espanhol : Cursos {
    ...
    public Espanhol(string Nome, string Nivel, double Duracao, bool Conclusao ){
        this.Nome = Nome;
        this.Nivel = Nivel;
    ...
    public void GerarCertificado(){
        if(Conclusao && AcimaMedia){
            Console.WriteLine($"Seu Certificado de Conclusao do Curso de Espanhol {Nivel} foi enviado para seu Email.");
        }else{
            Console.WriteLine("Seu Curso de Espanhol ainda nao foi Concluido!");
        }
    }
}