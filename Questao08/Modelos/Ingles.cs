public class Ingles : Cursos{
    ...
    public Ingles(string Nome, string Nivel, double Duracao, bool Conclusao ){
        this.Nome = Nome;
        this.Nivel = Nivel;
    ...
    public void GerarCertificado(){
        if(Conclusao && AcimaMedia){
            Console.WriteLine($"Seu Certificado de Conclusao do Curso de Ingles {Nivel} foi enviado para seu Email.");
        }else{
            Console.WriteLine("Seu Curso de Ingles ainda nao foi Concluido!");
        }
    }
